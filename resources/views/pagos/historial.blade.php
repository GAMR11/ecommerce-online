                                    ...
                                    <tbody>
                                        @foreach ($pagos as $key => $pago)
                                            <tr id="id-pago-{{ $pago->id }}" data-id="{{ $pago->id }}"
                                                ...
                                                <td>{{ $pago->cliente->nombre }} {{ $pago->cliente->apellidos }} <a class="btn btn-info" title="Ver cliente" data-bs-toggle="modal" data-bs-target="#infoModalCliente{{ $pago->id }}"><i class="fas fa-eye"></i></a></td>
                                                            ...
                                                            {{-- <div class="row g-6">
                                                                <div class="col mb-0">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $pago->nombre }}" readonly />
                                                                </div>
                                                                <div class="col mb-0">
                                                                    <label for="marca" class="form-label">Marca</label>
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $pago->marca }}" readonly />
                                                                </div>
                                                            </div>
                                                            <div class="row g-6">
                                                                <div class="col mb-0">
                                            ...
                                            <div class="modal fade" id="editarModal{{ $pago->id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <form id="formEditarpago{{ $pago->id }}" method="POST" action="{{ route('pago.update',$pago->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        {{ method_field('PUT') }}
                                                        {{-- <div class="modal-content">
                                                            <div class="modal-header">
